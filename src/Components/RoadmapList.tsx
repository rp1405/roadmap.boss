            ...
            <div className='px-2 md:w-[1200px] lg:w-[1500px] md:mx-auto'>
                ...
                <div className= 'px-2 lg:px-[14%]'>
                    ...
                    <div className='grid lg:grid-cols-3 grid-cols-1 sm:grid-cols-2 lg:gap-2 md:gap-2 gap-2'>
                        ...
                        {createYourRoadmap && <button className='border-slate-800 border-[1.5px] hover:border-white text-slate-400 py-3 sm:py-5 text-cemter pl-3 text-lg sm:text-xl font-normal  rounded-lg lg:w-[350px] sm:w-[99%] w-full'> + Create you own Roadmap</button>}
