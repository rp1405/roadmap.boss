...
const CommunitySec = () => {
    return (
        <div className=' py-6  sm:py-12  px-4 md:mx-[18%]  sm:text-center ' >
            ...
            <p className='text-xl my-6 px-40'>roadmap.sh is the <u className='font-semibold'>6th most starred project on GitHub</u> and is visited by hundreds of thousands of developers every month.</p>

            <div className='sm:flex'>

                <div className='w-full bg-guideSectionBg p-2 rounded-lg my-4 sm:bg-white'>
                ...
                <div className='w-full bg-guideSectionBg p-2 rounded-lg my-4 sm:bg-white  sm:border-l-2 sm:border-r-2'>
                    <h1 className='text-xl text-blue-500'><span className='bg-blue-500 text-white rounded-md p-1'>Rank 6th</span> put of 28M!</h1>
                    <h1 className='py-5 text-2xl'><span className='font-bold'>258k</span> GitHub Stars</h1>
                    <button className='p-2 bg-white border border-black rounded-md w-60'>
