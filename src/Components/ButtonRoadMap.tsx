...
const ButtonRoadMap: React.FC<ButtonProps> = ({label,bookmarked,dotIcon,showBookmark}) => {
  ...
  return (
      <div className=''>
          <button className='relative bg-headerBgTop border-slate-600 border hover:border-white text-slate-400  py-5 lg:pr-60 md:pr-96 pr-[430px] text-xl font-semibold rounded-lg lg:w-[350px] md:w-[500px] w-[97%]'>
              {label}
