...
const CommunitySec = () => {
  const data = [
    {
      ...
      headingInfo: "Subscribe Youtube",
      subHeadingInfo: "Help us reach #1",
      isBorder: false,
      onClick: () => {
        window.open("https://topmate.io/focusfreak", "_blank");
      },
    },
    {
      blueBgText: "+55k",
      ...
      headingInfo: "LinkedIn",
      subHeadingInfo: "Commit to your growth",
      isBorder: true,
      onClick: () => {
        window.location.href = "https://www.linkedin.com/in/abhishekkumar1775";
      },
    },
    // {
    //   blueBgText: "+1.5k",
  ...
  return (
    <div className=" py-6  sm:py-12  px-4 md:mx-[18%]  sm:text-center ">
      ...
      <p className="text-sm sm:text-xl my-6 sm:px-40">
        roadmap.college is the{" "}
        <u className="font-semibold">6th most starred project on GitHub</u> and
        is visited by hundreds of thousands of developers every month.
      </p>
