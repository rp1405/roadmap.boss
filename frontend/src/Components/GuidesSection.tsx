...
const GuidesSection: React.FC<GuidesSectionProps> = (props) => {
  ...
  return (
    <div className=" py-6 sm:py-12  px-2 md:px-[18%] bg-guideSectionBg ">
      ...
      <Link to={`/learn/${heading.toLowerCase()}`}>
        <button className="border border-black hover:bg-blue-500 w-full py-2 rounded-md text-xl sm:rounded-3xl sm:w-44 sm:text-lg sm:bg-gradient-to-r from-viewAllLeft to-viewAllRight sm:text-white ">
          View All {heading} →
        </button>
      </Link>
    </div>
